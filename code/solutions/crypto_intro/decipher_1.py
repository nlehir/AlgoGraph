    ...
    while extract not in decoded_message and attempt < max_number_of_attempts:
        ...
        for character in code:
            ...
            if ascii_index > 64 and ascii_index < 91:
                ...
                # other solution
                # key_index = key.index(ascii_index) + 65
...
print(
    f"necessary time to have around 40% of chances of stopping the program {time_per_key*1e8/60} min"
)
