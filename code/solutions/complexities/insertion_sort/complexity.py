...
"""
    ...
    operations performed by insertion_sort
    as a function of the size of the list.

    Thus we will need to use a large number
    of random lists. We will use the discrete
...
def number_of_operations(n: int) -> float:
    ...
    for _ in range(number_of_tests):
        ...
        counters.append(insertion_sort(uniform_llist, verbose=False))
...
def main() -> None:
    ...
    theoretical_values = [n * (n - 1) / 4 + n  for n in values_of_n]
